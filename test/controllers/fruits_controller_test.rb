...
class FruitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fruit" do
    assert_difference('Fruit.count') do
      post fruits_url, params: { fruit: { name: @fruit.name, price: @fruit.price, stock: @fruit.stock } }, as: :json
    end
  ...
  test "should update fruit" do
    patch fruit_url(@fruit), params: { fruit: { name: @fruit.name, price: @fruit.price, stock: @fruit.stock } }, as: :json
    assert_response 200
  end
